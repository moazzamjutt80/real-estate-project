                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+92 3277857587</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>Dream House</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								| </li> 
								<li class="text-white "><i class=" fas fa-user-plus text-success me-2 "></i><a href="register.php"> Register &nbsp;&nbsp;    | </li> <?php } ?>
                                <li><i class="fas fa-user-plus text-success mr-1 "></i><a href="admin/index.php"> Admin</li>
								</ul>
                            </div>
                        </div>
                    </div>
