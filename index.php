                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>A way to determine the most efficient and profitable use of a property.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>They have the knowledge, networks, and commitment to help you make informed decisions</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Real estate agents are licensed professionals who help with real estate transactions. They can work independently or for a brokerage or other agent. Here are some things to consider when working with a real estate agent:</p>
									</div>
                                </li>
                            </ul>
                        </div>
