...
function checkAllPositiveValues() {
    const amount = document.getElementById("amount").value;
    const month = document.getElementById("month").value;
    const interest = document.getElementById("interest").value;

    if (amount < 0 || month < 0 || interest < 0) {
        alert("All values should be greater than 0.");
        
        // Resetting the values of all inputs if any of them is negative
        if (amount < 0) document.getElementById("amount").value = "";
        if (month < 0) document.getElementById("month").value = "";
        if (interest < 0) document.getElementById("interest").value = "";
    }
}
